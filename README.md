...
<li style="color:red;> " wget https://bin.equinox.io/c/bNyj1mQVY4c/ngrok-v3-stable-linux-amd64.tgz "</li>
<li style="color:red;> "tar zxvf /path/to/ngrok.tgz"</li>
<li style="color:red;> "./ngrok authtoken [your_auth_token]"</li>
...
<li style="color:red;>" pip install Flask "</li>

<h2>GUNICORN INSTALLATION: </h2>
<li style="color:red;>" pip install gunicorn "</li>
...
<li style="color:red;>" sudo python app.py "</li>
<li>then open a new terminal in the same directory and run </li>
<li style="color:red;>" python3 -m gunicorn -w 4 -b 127.0.0.1:8080 app:app "</li>
<li style="color:red;>r"ngrok http 5000"</li>
...
<li style="color:red;>"sudo chmod -R 755 /var/www/html" </li>
